...
CREATE TABLE IF NOT EXISTS `happypet`.`Terceros` (
  ...
  `fecha_creacion` DATETIME NOT NULL COMMENT 'Fecha en que se crea al tercero',
  `usuario_id_usuario` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `happypet`.`Items` (
  ...
  `fecha_creacion` DATETIME NOT NULL COMMENT 'fecha de creación del item',
  ...
  `estado` VARCHAR(1) NOT NULL COMMENT 'Activo o inactivo',
